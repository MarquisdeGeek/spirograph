...
YUISlider = function(divStub, params) {
	...
	var slider = YAHOO.widget.Slider.getHorizSlider("slider-bg", divSlider, 0, 200, 1);
...
var spiro = new SimpleSpirograph();
var iface = new SimpleSpirographinterface(spiro);
